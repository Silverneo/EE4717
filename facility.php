...
<div class="wrapper">
	...
	<div class="content">
		...
		<p style="margin: 20px auto;"><i class="fa fa-quote-left pull-left fa-border"></i>
			Experience the extraordinary and work out with your friends and family. By offering a wide range of facilities, you can simply 
			choose the sport you like and make the booking! Next step, just bring your friends and come!
		...
		<div style="width: 80%; text-align: center; margin-left: 10%; margin-top: 35px;">
			<h2>Cannot find the one you like?</h2>
			<p style="margin: 20px auto;">
				Don't worry, we have TWO more indoor sports halls available for a wide variety of sports.
			</p>
		</div>
		<br>
		<p>
